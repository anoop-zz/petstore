  ...
  return (
    ...
    >
      <View style={styles.title}>
        <Text style={styles.titleText}> Registration Screen</Text>
      </View>
      <Formik
      ...
      >
        {({ handleChange, handleBlur, handleSubmit, values, errors }) => (
          <View>
            ...
            />
            {errors.firstName && (
              <Text style={{ color: "yellow" }}>{errors.firstName}</Text>
            )}
            <TextInput
            ...
            />
            {errors.username && (
              <Text style={{ color: "yellow" }}>{errors.username}</Text>
            )}
            <TextInput
            ...
            />
            {errors.phone && (
              <Text style={{ color: "yellow" }}>{errors.phone}</Text>
            )}
            <TextInput
              placeholder="Email"
